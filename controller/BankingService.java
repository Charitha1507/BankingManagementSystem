...
public class BankingService {
	...
	public void apply_loan(String acc_no, double amt, int duration,double salary) {
		if(accounts.containsKey(acc_no)==true) {
			Account account=accounts.get(acc_no);
			Loan loan=new Loan(acc_no,amt,duration,salary);
	...
	public void processloan(String acc_no)
	{
		if(loans.containsKey(acc_no))
		{
		    ...
		    if(approved) {
		    	...
		    	System.out.println("Amount credited to your account "+acc_no+" . Monthly EMI: "+loan.calculate_EMI());
		    }
		    else {
