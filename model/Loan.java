...
public class Loan {
     ...
     private double interest_rate=5.00;
     private int duration_months;
     private Date issue_date;
     private String status;
     private double salary;
	public Loan(String acc_no, double loan_amt, int duration_months,double salary) {
		super();
		this.acc_no = acc_no;
   ...
   public double calculate_EMI() {
	  ...
	  return (loan_amt*monthly_interest_rate*Math.pow(1+monthly_interest_rate, duration_months))/(Math.pow(1+monthly_interest_rate,duration_months)-1);
   }
@Override
